...
#Do checks if greater than account amount for sell
#Consistent rounding/truncating system for BOTH buy/sell
#Go over ideal logic we would want, dont lookat code
#To think of new features
