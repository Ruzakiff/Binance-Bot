...
while True:
	try:
		...
		symbol_ticker=symbol_ticker.replace(" ","")
		print symbol_ticker
		with open ("/Users/ryan/Desktop/Doggo4/ethbtc_price.txt", "a") as outfile: #change filepath to filepath of data.txt
			#bring with open to outer scope, dont open each time
